...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2106185312286359777, ; hash 0x1d3aac61e9f940e1, from name: libaot-AppYamukov2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppYamukov2.dll.so
		ptr null; void* handle (0x0)
	}, ; 47
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2249814783126024203, ; hash 0x1f38f2a00ea6300b, from name: AppYamukov2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppYamukov2.dll.so
		ptr null; void* handle (0x0)
	}, ; 53
	...
	%struct.DSOCacheEntry {
		i64 4065701033191826305, ; hash 0x386c458c76566381, from name: aot-AppYamukov2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppYamukov2.dll.so
		ptr null; void* handle (0x0)
	}, ; 105
	...
	%struct.DSOCacheEntry {
		i64 9222396087332641136, ; hash 0x7ffc88610b6a1970, from name: aot-AppYamukov2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppYamukov2.dll.so
		ptr null; void* handle (0x0)
	}, ; 234
	...
	%struct.DSOCacheEntry {
		i64 13362449549537737475, ; hash 0xb970f51169467b03, from name: AppYamukov2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppYamukov2.dll.so
		ptr null; void* handle (0x0)
	}, ; 347
	...
	%struct.DSOCacheEntry {
		i64 15972988498012879576, ; hash 0xddab746911753ad8, from name: libaot-AppYamukov2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppYamukov2.dll.so
		ptr null; void* handle (0x0)
	}, ; 417
...
@.env.3 = private unnamed_addr constant [37 x i8] c"b94bc2ca-16bb-4eaf-acf3-e15fb6735f8c\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.appyamukov2\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [26 x i8] c"libaot-AppYamukov2.dll.so\00", align 16
