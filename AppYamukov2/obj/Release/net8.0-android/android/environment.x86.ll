...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 101932366, ; hash 0x6135d4e, from name: libaot-AppYamukov2.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 117438640, ; hash 0x6fff8b0, from name: aot-AppYamukov2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppYamukov2.dll.so
		ptr null; void* handle (0x0)
	}, ; 9
	...
	%struct.DSOCacheEntry {
		i64 215490296, ; hash 0xcd81ef8, from name: AppYamukov2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppYamukov2.dll.so
		ptr null; void* handle (0x0)
	}, ; 21
	...
	%struct.DSOCacheEntry {
		i64 382077625, ; hash 0x16c60ab9, from name: AppYamukov2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppYamukov2.dll.so
		ptr null; void* handle (0x0)
	}, ; 44
	...
	%struct.DSOCacheEntry {
		i64 1717715060, ; hash 0x66624074, from name: aot-AppYamukov2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppYamukov2.dll.so
		ptr null; void* handle (0x0)
	}, ; 180
	...
	%struct.DSOCacheEntry {
		i64 4110833134, ; hash 0xf50655ee, from name: libaot-AppYamukov2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppYamukov2.dll.so
		ptr null; void* handle (0x0)
	}, ; 458
